...
val v_b: Int = v_a match{
  case CC_C(CC_C(_, _, _), CC_B(), _) => 0 
  case CC_C(_, _, _) => 1 
}
}
// This is not matched: (CC_C (CC_D (T_A Boolean Boolean) (T_A Boolean Boolean))
//      (T_A (T_B Boolean Boolean) (T_B Boolean Boolean))
//      Wildcard
//      Wildcard
//      Wildcard
//      (T_B Char (CC_D (T_A Boolean Boolean) (T_A Boolean Boolean))))
