...
Integer v_b = switch (v_a){
  ...
  case R_A(R_A(R_A(var a, var b), var c), R_C(R_B())) -> 2; 
  case R_A(R_B(), var a) -> 3; 
  case R_A(var a, R_C(R_A(var b, var c))) -> 4; 
...
// Generalizing a concrete pattern in R_A(var WILDCARD, var WILDCARD) at pattern position 11 to a wildcard pattern :
// {
//  var WILDCARD
// }
//
