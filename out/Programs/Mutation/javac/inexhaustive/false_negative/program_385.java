...
Integer v_b = switch (v_a){
  case R_A(R_D(), var a, R_C()) -> 0; 
  case R_A(var a, var b, R_D()) -> 1; 
  case R_A(R_C(), var a, var b) -> 2; 
  case R_B() -> 3; 
};
}
...
// Generalizing a concrete pattern in R_C(var WILDCARD, var WILDCARD) at pattern position 26 to a wildcard pattern :
// {
//  var WILDCARD
// }
//
