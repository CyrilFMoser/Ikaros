...
Integer v_b = switch (v_a){
  ...
  case R_A(var a, R_D()) -> 1; 
  case R_A(var a, R_E()) -> 2; 
  case R_A(var a, R_C(R_B())) -> 3; 
  case R_A(R_B(), var a) -> 4; 
  case R_A(R_A(R_A(var a, var b), var c), R_C(R_A(var d, var e))) -> 5; 
};
}

};
// Mutation information: 
// Generalizing a concrete pattern in R_A(R_A(var WILDCARD, var WILDCARD), R_C(var WILDCARD)) at pattern position 6 to a wildcard pattern :
// {
//  var WILDCARD
// }
//
