...
Integer v_b = switch (v_a){
  ...
  case R_A(R_A(var a, R_C(var b)), R_C(R_A(var c, var d))) -> 1; 
  case R_A(var a, R_D()) -> 2; 
  case R_A(var a, R_E()) -> 3; 
  case R_A(var a, R_C(R_B())) -> 4; 
  case R_A(R_A(var a, R_D()), var b) -> 5; 
...
// Generalizing a concrete pattern in R_A(var WILDCARD, var WILDCARD) at pattern position 13 to a wildcard pattern :
// {
//  var WILDCARD
// }
//
