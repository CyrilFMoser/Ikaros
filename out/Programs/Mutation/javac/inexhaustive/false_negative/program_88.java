...
Integer v_b = switch (v_a){
  case R_A(var a, R_E()) -> 0; 
  case R_A(R_A(R_A(var a, var b), R_C(var c)), var d) -> 1; 
  case R_A(R_A(R_B(), var a), var b) -> 2; 
  case R_A(R_A(var a, R_D()), var b) -> 3; 
  case R_A(R_A(var a, R_E()), R_C(var b)) -> 4; 
...
// Expanded var WILDCARD at position 11 into: 
// {
//  R_A(var WILDCARD, var WILDCARD)
// }
//
