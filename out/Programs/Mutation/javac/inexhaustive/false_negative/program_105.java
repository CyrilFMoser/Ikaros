...
Integer v_b = switch (v_a){
  ...
  case R_A(R_A(var a, R_C(var b)), R_C(var c)) -> 2; 
...
// Generalizing a concrete pattern in R_A(R_A(var WILDCARD, var WILDCARD), var WILDCARD) at pattern position 13 to a wildcard pattern :
// {
//  var WILDCARD
// }
//
