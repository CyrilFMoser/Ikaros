...
Integer v_b = switch (v_a){
  case R_A(R_A(var a, R_E()), R_C(var b)) -> 0; 
  case R_A(R_A(R_B(), var a), var b) -> 1; 
  case R_A(R_A(var a, R_C(var b)), var c) -> 2; 
  case R_A(var a, R_E()) -> 3; 
  case R_A(R_A(R_A(var a, var b), R_D()), var c) -> 4; 
...
// Expanded var WILDCARD at position 6 into: 
// {
