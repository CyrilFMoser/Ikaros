...
Integer v_b = switch (v_a){
  case R_A(R_A(var a, R_C(var b)), R_C(R_A(var c, var d))) -> 0; 
...
// Generalizing a concrete pattern in R_A(var WILDCARD, var WILDCARD) at pattern position 6 to a wildcard pattern :
// {
//  var WILDCARD
// }
//
