...
Integer v_b = switch (v_a){
  ...
  case R_A(var a, R_D()) -> 4; 
  case R_A(R_B(), var a) -> 5; 
  case R_A(R_A(R_A(var a, var b), R_D()), R_C(var c)) -> 6; 
};
}

};
// Mutation information: 
// Generalizing a concrete pattern in R_A(var WILDCARD, R_D()) at pattern position 19 to a wildcard pattern :
// {
//  var WILDCARD
// }
//
