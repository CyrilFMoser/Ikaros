...
Integer v_b = switch (v_a){
  ...
  case R_A(R_A(var a, R_D()), R_C(R_A(var b, var c))) -> 5; 
...
// Generalizing a concrete pattern in R_A(var WILDCARD, var WILDCARD) at pattern position 17 to a wildcard pattern :
// {
//  var WILDCARD
// }
//
