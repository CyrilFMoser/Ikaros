...
Integer v_b = switch (v_a){
  ...
  case R_A(R_A(R_A(var a, var b), var c), var d) -> 1; 
  case R_A(R_A(R_B(), R_C(var a)), var b) -> 2; 
  case R_A(R_A(var a, R_D()), var b) -> 3; 
  case R_A(R_B(), var a) -> 4; 
  case R_A(R_A(var a, R_E()), R_C(var b)) -> 5; 
...
// Expanded var WILDCARD at position 13 into: 
// {
