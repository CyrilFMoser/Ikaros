...
val v_b: Int = v_a match{
  ...
  case CC_B(CC_E(CC_C(_)), (CC_A(_),CC_B(_, _))) => 12 
  case CC_B(CC_E(CC_B(_, _)), (CC_A(_),CC_B(_, _))) => 12 
  case CC_B(CC_E(CC_A(_)), (CC_A(_),CC_B(_, _))) => 12 
  ...
  case CC_B(CC_D(_, _, _), (CC_B(_, _),CC_B(_, _))) => 18 
}
}
