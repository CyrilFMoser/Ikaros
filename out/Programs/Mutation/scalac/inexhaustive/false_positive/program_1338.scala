...
val v_b: Int = v_a match{
  ...
  case CC_F(CC_E(_, _, CC_F(_, _, _)), 12, CC_C()) => 12 
  case CC_F(CC_E(_, _, CC_E(_, _, _)), 12, CC_C()) => 12 
  case CC_F(CC_E(_, _, CC_D(_, _, _)), 12, CC_C()) => 12 
...
// }
//
// This is not matched: (CC_E (CC_B (T_B T_A) (T_B T_A))
//      T_A
//      Wildcard
//      (CC_C T_A)
//      Wildcard
//      (T_B (CC_B (T_B T_A) (T_B T_A))))
// Mutation information: 
