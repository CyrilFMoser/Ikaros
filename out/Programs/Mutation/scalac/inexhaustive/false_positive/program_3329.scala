...
val v_b: Int = v_a match{
  ...
  case CC_A(CC_A(_, CC_C(_), _), CC_A(_, _, _), CC_B(_, _, _)) => 7 
  case CC_A(CC_A(_, CC_B(_, _, _), _), CC_A(_, _, _), CC_B(_, _, _)) => 7 
  case CC_A(CC_A(_, CC_A(_, _, _), _), CC_A(_, _, _), CC_B(_, _, _)) => 7 
