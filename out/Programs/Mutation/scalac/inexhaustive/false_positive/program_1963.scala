...
val v_b: Int = v_a match{
  ...
  case CC_C(CC_C(_, _, _), _, CC_A()) => 6 
  case CC_C(CC_B(_), _, CC_A()) => 6 
  case CC_C(CC_C(_, _, _), _, _) => 6 
  case CC_C(_, _, CC_B(_)) => 7 
}
}
...
// }
//
// This is not matched: (CC_C (CC_B Boolean Boolean T_A) Wildcard Wildcard T_A)
// Mutation information: 
