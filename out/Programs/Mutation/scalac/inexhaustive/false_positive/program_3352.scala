...
val v_b: Int = v_a match{
  ...
  case CC_A(CC_A(_, _, _), CC_A(_, _, _), CC_A(_, _, CC_C(_))) => 11 
  case CC_A(CC_A(_, _, _), CC_A(_, _, _), CC_A(_, _, CC_B(_, _, _))) => 11 
  case CC_A(CC_A(_, _, _), CC_A(_, _, _), CC_A(_, _, CC_A(_, _, _))) => 11 
