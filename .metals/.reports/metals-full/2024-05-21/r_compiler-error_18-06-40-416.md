...
record R_A<C, D>(D a, I_A<C, Integer> b) implements I_A<C, Integer>{}
record R_B<E>() implements I_A<E, Integer>{}
public static void main(String args[]) {

I_A<Byte, Integer> v_a = null;
Integer v_b = switch (v_a){
  case R_A<Byte, D>(var a, R_A<Byte, D>(var b, var c)) -> 0; 
  case R_A<Byte, D>(var a, R_B<Byte>()) -> 1; 
  case R_B<Byte>() -> 2; 
};
}
